...
class MyCapitalView(LoginRequiredMixin, View):
    login_url = '/login/'
    redirect_field_name = 'next'

    def get(self, request):
        #user_capitals = UserCourse.objects.filter(user=request.user)
        return render(request, "usercenter-capital.html", {
...
class MyOrderView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        #user_capitals = UserCourse.objects.filter(user=request.user)
        return render(request, "usercenter-order.html", {
